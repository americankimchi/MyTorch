...
class Tensor:
    ...
    A wrapper around a NumPy array that helps to interact with MyTorch.

    Args:
        data (np.array): the actual data of the tensor
        requires_grad (boolean): If true, accumulate gradient in `.grad`
        is_leaf (boolean): If true, this is a leaf tensor
    ...
    def __init__(self, data, requires_grad=False, is_leaf=True,
        ...
        self.grad_fn = None # Set during forward pass (populated in Function.apply())
        self.grad = None
    ...
    # This is a METHOD to be implmented in tensor.Tensor class.
    def __getitem__(self, key):
        # Simply invoke the appropriate function from functional.py
    ...
    # @ operation on tensors call this
    ...
    def __pow__(self, exponent):
        return F.Power.apply(self, exponent)
    ...
    def unsqueeze(self,dim=0):
        ...
        return F.Reshape.apply(self, tuple(new_shape))
...
def cat(seq,dim=0):
    ...
    Args:
        seq (list of Tensors) - List of seq tensors to concatenate
