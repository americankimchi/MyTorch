...
class GRUUnit(Module):
    ...
    def forward(self, input, hidden = None):
        ...
        r_t = Sigmoid()(input@self.weight_ir.T() + self.bias_ir + hidden@self.weight_hr.T() + self.bias_hr)
        z_t = Sigmoid()(input@self.weight_iz.T() + self.bias_iz + hidden@self.weight_hz.T() + self.bias_hz)
        n_t = Tanh()(input@self.weight_in.T() + self.bias_in + (r_t * (hidden@self.weight_hn.T() + self.bias_hn)))

        return (Tensor(1)-z_t) * n_t + z_t * hidden
